...
class DQNCritic(BaseCritic):
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        qa_tp1_values = self.q_net_target.forward(next_ob_no).detach()
        ...
        if self.double_q:
            ...
            next_ac_na = self.q_net.forward(next_ob_no).argmax(dim=1)
        ...
        target = reward_n + self.gamma * q_tp1.detach() * (1 - terminal_n)
        ...
        self.optimizer.step()
        self.learning_rate_scheduler.step() # todo: check if needed
